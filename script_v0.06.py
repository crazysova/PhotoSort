#!/usr/bin/env python3
# Добавлены следующие функции и изменения:
# 1. Исправлено дублирование меню "Файл" при открытии новой папки: меню создаётся один раз в init_ui и не пересоздаётся.
# 2. Убран пункт "Очистить корзину" из меню "Файл".

import sys
import os
from PyQt5.QtWidgets import QApplication, QMainWindow, QLabel, QFrame, QVBoxLayout, QHBoxLayout, QWidget, QPushButton, QFileDialog, QMenuBar
